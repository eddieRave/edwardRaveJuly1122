...
class ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        coder.work() // Prints either "intense coding" or "not so intense"
    }

}

//delegation assignment, change the current types to use delegation, make a pull request from branch name-11-delegation
...
/* Advantages of Delegation
 ...
 - can pass info as parameters from Coder into Assistant class
    ...
    Delegates and protocols: one-to-one
 */

class Coder {
    var delegate: CoffeeDelegate?
    var hasEnergy = false
    func work() {
